...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-8 h-8 rounded-lg bg-gray-200 dark:bg-white/10 text-gray-600 dark:text-gray-300 flex items-center justify-center hover:bg-gray-300 dark:hover:bg-white/20 transition-colors cursor-pointer"
      title="Toggle Theme"
    >
      {currentTheme === "dark" ? (
