    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={goToToday}
            className="px-2.5 py-1 text-[10px] uppercase tracking-wider font-semibold text-indigo-300 bg-indigo-500/10 border border-indigo-500/20 rounded-lg hover:bg-indigo-500/20 transition-all cursor-pointer"
          >
            Today
          </button>
        </div>
          ...
          {cells.map((day, i) => {
            ...
            return (
              <div
                ...
                className={`min-h-[90px] md:min-h-[100px] p-1.5 border-b border-r border-white/[0.04] transition-colors ${
                  day ? "cursor-pointer hover:bg-white/[0.02]" : "bg-white/[0.005]"
