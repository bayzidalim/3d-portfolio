    ...
    <div className="space-y-5">
      ...
      <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            onClick={onTaskAdd}
            className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-medium bg-indigo-500/20 text-indigo-200 border border-white/10 rounded-lg hover:bg-indigo-500/30 transition-all cursor-pointer"
          >
      ...
      <div className="space-y-1.5">
        {sorted.length === 0 ? (
          ...
          sorted.map((task) => (
            <div
              key={task._id}
              className="group flex items-center gap-3 px-4 py-3 rounded-xl border border-white/[0.04] hover:border-white/[0.08] bg-white/[0.01] hover:bg-white/[0.03] transition-all"
            >
              {/* Checkbox */}
              <button
