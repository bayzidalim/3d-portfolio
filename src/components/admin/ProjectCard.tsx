...
export default function ProjectCard({ project, taskStats, onEdit, onDelete }: ProjectCardProps) {
  ...
  return (
    <Link
      ...
      className="group block rounded-2xl border border-gray-200 dark:border-white/[0.06] bg-white dark:bg-white/[0.02] hover:bg-gray-50 dark:hover:bg-white/[0.04] hover:border-gray-300 dark:hover:border-white/[0.1] hover:-translate-y-1 active:scale-[0.98] hover:shadow-xl hover:shadow-gray-200 dark:hover:shadow-white/5 shadow-sm dark:shadow-none transition-all duration-300 ease-out p-5 relative overflow-hidden animate-[fade-in-up_0.4s_ease-out_forwards]"
    >
      {/* Color accent bar */}
      <div
      ...
      <div className="flex items-start justify-between mb-3 mt-1">
        <div className="flex items-center gap-3 min-w-0">
          <div
            className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 border border-gray-100 dark:border-white/[0.06]"
          ...
          <div className="min-w-0">
            <h3 className="font-semibold text-sm text-gray-900 dark:text-white truncate">{project.title}</h3>
            {project.description && (
        ...
        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
          <button
            ...
            className="p-1.5 rounded-lg text-gray-500 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/[0.06] transition-all cursor-pointer"
            title="Edit project"
          >
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-gray-500 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-all cursor-pointer"
