    ...
    <aside className="fixed top-0 left-0 h-full w-64 bg-[#030412] border-r border-white/[0.06] p-6 flex flex-col z-40 max-lg:hidden">
      ...
      <div className="mt-auto space-y-2">
        ...
        <button
          ...
          className="flex w-full items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-gray-500 hover:text-red-400 hover:bg-red-500/[0.06] transition-all duration-200 cursor-pointer"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
